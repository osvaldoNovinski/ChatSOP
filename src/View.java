...
public class View extends JFrame implements ActionListener {
	...
	public static String getUsuarioUmStr() {
		return usuarioUmStr;
	}

	public static void setUsuarioUmStr(String usuarioUmStr) {
		View.usuarioUmStr = usuarioUmStr;
	}
	...
	public void atualizaTela(String tLinha, String usuario) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnEnviar) {
			...
			exct.setUsuario(usuarioUmStr.toString());
			exct.settLinha(mensagem.getText().toString());
		...
		if (e.getSource() == btnOk) {
			try {
				...
				exct = new ExemploClienteThread(socket);
				System.out.println("Foi exct socket");
